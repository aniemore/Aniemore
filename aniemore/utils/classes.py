...
RecognizerOutput: TypeAlias = dict[str, ModelOutput]
...
class BaseRecognizer:
    ...
    def predict(self, *args, **kwargs) -> Union[ModelOutput, RecognizerOutput]:
        raise NotImplementedError

    def _predict_one(self, *args, **kwargs) -> ModelOutput:
        raise NotImplementedError

    def _predict_many(self, *args, **kwargs) -> RecognizerOutput:
        raise NotImplementedError

    def _get_single_label(self, *args, **kwargs) -> str:
        raise NotImplementedError
